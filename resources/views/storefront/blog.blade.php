<x-storefront-layout title="Blog - Tech Ecom">
    <main class="main">
                            ...
                            <div class="row">
                                    ...
                                    <article class="first-post mb-30 wow fadeIn animated hover-up">
                                        <div class="img-hover-slide position-relative overflow-hidden">
                                            ...
                                            <div class="post-thumb img-hover-scale">
                                                <a href="{{ route('blog', ['slug' => 'hello-world']) }}">
                                        ...
                                        <div class="entry-content">
                                            ...
                                            <h2 class="post-title mb-20">
                                                <a href="{{ route('blog', ['slug' => 'hello-world']) }}">Barcelona:
                                                    marathan;
                                                    south korean pulls away
                                                    for a grueling surprise</a>
                                            </h2>
                                            <p class="post-exerpt font-medium text-muted mb-30">These people envy me for
                                                having a lifestyle they don’t have, but the truth is, sometimes I envy
                                                their lifestyle instead. Struggling to sell one multi-million dollar
                                                home currently.</p>
                                    ...
                                    <article class="wow fadeIn animated hover-up mb-30">
                                        ...
                                        <div class="entry-content-2">
                                            <h3 class="post-title mb-15">
                                                <a href="{{ route('blog', ['slug' => 'hello-world']) }}">The litigants
                                                    on the
                                                    screen are not
                                                    actors</a>
                                            </h3>
                                            <p class="post-exerpt mb-30">These people envy me for having a lifestyle
                                                they don’t have, but the truth is, sometimes I envy their lifestyle
                                                instead. Struggling to sell one multi.</p>
                                ...
                                <div class="col-lg-6">
                                    <article class="wow fadeIn animated hover-up mb-30">
                                        ...
                                        <div class="entry-content-2">
                                            <h3 class="post-title mb-15">
                                                <a href="{{ route('blog', ['slug' => 'hello-world']) }}">Essential
                                                    Qualities
                                                    of Highly Successful
                                                    Music</a>
                                            </h3>
                                            <p class="post-exerpt mb-30">Graduating from a top accelerator or incubator
                                                can be as career-defining for a startup founder as an elite university
                                                diploma. The intensive programmes, which</p>
                                            <div class="entry-meta meta-1 font-xs color-grey mt-10 pb-10">
                                                <div>
                                                    <span class="post-on"> <i class="fi-rs-clock"></i> 25 April
                                                        2022</span>
                                ...
                                <div class="col-lg-6">
                                    <article class="wow fadeIn animated hover-up mb-30">
                                        ...
                                        <div class="entry-content-2">
                                            <h3 class="post-title mb-15">
                                                <a href="{{ route('blog', ['slug' => 'hello-world']) }}">9 Things I
                                                    Love
                                                    About Shaving My Head</a>
                                            </h3>
                                            <p class="post-exerpt mb-30">At the Emmys, broadcast scripted shows created
                                                by people of color gained ground relative to those pitched by White show
                                ...
                                <div class="col-lg-6">
                                    <article class="wow fadeIn animated hover-up mb-30">
                                        ...
                                        <div class="entry-content-2">
                                            <h3 class="post-title mb-15">
                                                <a href="{{ route('blog', ['slug' => 'hello-world']) }}">Why Teamwork
                                                    Really Makes The Dream
                                                    Work</a>
                                            </h3>
                                            <p class="post-exerpt mb-30">We live in a world where disruption and
                                                dynamism reign supreme and businesses must be ready to adapt to the many
                                ...
                                <div class="col-lg-6">
                                    <article class="wow fadeIn animated hover-up mb-30">
                                        ...
                                        <div class="entry-content-2">
                                            <h3 class="post-title mb-15">
                                                <a href="{{ route('blog', ['slug' => 'hello-world']) }}">The World
                                                    Caters
                                                    to Average People</a>
                                            </h3>
                                            <p class="post-exerpt mb-30">These people envy me for having a lifestyle
                                                they don’t have, but the truth is, sometimes I envy their lifestyle
                                                instead. Struggling to sell oney.</p>
                                            <div class="entry-meta meta-1 font-xs color-grey mt-10 pb-10">
                                                <div>
                                                    <span class="post-on"> <i class="fi-rs-clock"></i> 25 April
                                                        2022</span>
