                                ...
                                <div class="row align-items-center slider-animated-1">
                                    <div class="col-lg-5 col-md-6">
                                        <div class="hero-slider-content-2">
                                            @if ($promotion->subtitle)
                                                <h4 class="animated">{{ $promotion->subtitle }}</h4>
                                            @endif
                                            @if ($promotion->title)
                                                <h2 class="animated fw-900">{{ $promotion->title }}</h2>
                                            @endif
                                    ...
                                    <div class="col-lg-7 col-md-6">
                                        <div class="single-slider-img single-slider-img-1">
                                            @if ($promotion->image)
                                                <img class="animated slider-1-{{ $loop->iteration }}"
                                                    src="{{ $promotion->image->file_path }}"
                                                    alt="{{ $promotion->title }}">
                                            @endif
                                        </div>
                                    </div>
            ...
            <div class="container">
                <div class="banner-img banner-big wow fadeIn animated f-none">
                    ...
                    <div class="banner-text d-md-block d-none">
                        ...
                        <h1 class="fw-600 mb-20">We're an Apple <br>Authorized Service Provider</h1>
                            ...
                            <div class="card-1">
                                <figure class="img-hover-scale overflow-hidden">
                                    <a href="{{ route('shop', ['category' => $category->slug]) }}">
                                        <img src="{{ $category->image->file_path }}" alt="">
                                    </a>
                                </figure>
                                <h5>
                                    <a href="{{ route('shop', ['category' => $category->slug]) }}">
