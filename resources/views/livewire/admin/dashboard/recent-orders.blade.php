<div class="bg-white dark:bg-gray-800 shadow-xs rounded-lg p-5">
    ...
    <div class="mt-4 overflow-x-auto h-[400px] overflow-y-auto">
        <table class="min-w-full text-left text-sm">
            <thead class="text-gray-500 dark:text-gray-400">
                <tr>
                    <th class="py-2 px-4 sticky top-0 bg-gray-100">Order</th>
                    <th class="py-2 pr-4 sticky top-0 bg-gray-100">Status</th>
                    <th class="py-2 pr-4 sticky top-0 bg-gray-100">Payment</th>
                    <th class="py-2 pr-4 sticky top-0 bg-gray-100">Total</th>
                    <th class="py-2 pr-4 sticky top-0 bg-gray-100">Placed</th>
                </tr>
            </thead>
                    ...
                    <tr class="border-t border-gray-100 dark:border-gray-700/50">
                        <td class="py-2 pr-4 font-medium">
                            <a href="{{ route('admin.orders.show', $order) }}"
                                class="text-primary hover:underline">{{ $order->number }}</a>
                        </td>
                        <td class="py-2 pr-4">
                    ...
                    <tr>
                        <td colspan="5" class="py-4 text-center text-gray-500 dark:text-gray-400">
                            <div class="flex justify-center">
                                <button wire:click="loadMore" class="btn btn-light btn-sm" wire:loading.attr="disabled"
