                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <address class="mb-0">
                                                    ...
                                                    @endif
                                                    {{ $this->getFormattedBillingAddress() }}<br>
                                        ...
                                        <div class="card mt-3">
                                            ...
                                            <div class="card-body">
                                                <address class="mb-0">
                                                    ...
                                                    @endif
                                                    {{ $this->getFormattedShippingAddress() }}<br>
                                                ...
                                                @foreach ($order->paymentTransactions as $transaction)
                                                    <div class="mb-2">
                                                        ...
                                                        @if ($transaction->provider)
                                                            <br>
                                                            <small
                                                                class="text-muted">{{ $this->getFormattedPaymentProvider($transaction->provider) }}</small>
                                                        @endif
                                                        @if ($transaction->reference)
                                                            <br>
                                                            <small
                                                                class="text-muted">{{ $this->getFormattedPaymentReference($transaction->reference) }}</small>
                                                        @endif
                                                    </div>
                                                    @if (!$loop->last)
                                                        <hr>
