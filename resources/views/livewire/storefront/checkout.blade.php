                ...
                <form wire:submit="placeOrder">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <input type="text" wire:model="form.billing_address_line_2"
                                    placeholder="Address line 2">
                            </div>
                            <div class="form-group">
                                <input type="text" wire:model="form.billing_city" placeholder="City / Town *"
                                    required>
                            ...
                            <div class="form-group">
                                <input type="text" wire:model="form.billing_postal_code"
                            ...
                            <div class="ship_detail">
                                <div class="form-group">
                                    <div class="chek-form">
                                        <div class="custome-checkbox">
                                            <input class="form-check-input" type="checkbox"
                                                wire:model.live="form.ship_to_different_address"
                                                id="differentaddress">
                            ...
                            <div class="order_review">
                                ...
                                <div class="payment_method">
                                    ...
                                    <div class="payment_option">
                                        ...
                                        <div class="custome-radio">
                                            <input class="form-check-input" type="radio"
                                                wire:model="form.payment_method" value="card_payment"
                                                id="cardPayment">
