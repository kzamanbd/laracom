                                            ...
                                            <td class="text-center" data-title="Stock">
                                                <div class="detail-qty border radius m-auto">
                                                    <a href="#"
                                                        ...
                                                        wire:target="decrementQuantity,updateQuantity" class="qty-down">
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        wire:loading.attr="disabled"
                                                        wire:target="incrementQuantity,updateQuantity" class="qty-up">
                                    ...
                                    <tr>
                                        <td colspan="6" class="text-end">
                                            <a href="#" wire:click="clearCart"
                                                ...
                                                wire:loading.attr="disabled" wire:target="clearCart" class="text-muted">
                                ...
                                <form class="field_form shipping_calculator">
                                    ...
                                    <div class="form-row row">
                                        <div class="form-group col-lg-6">
                                            <input required="required" placeholder="State / Province" name="state"
                                                type="text">
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <input required="required" placeholder="PostCode / ZIP" name="zip"
                                                type="text">
                                        </div>
                                    </div>
                                    <div class="form-row">
