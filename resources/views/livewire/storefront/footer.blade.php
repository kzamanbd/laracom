            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="widget-about font-md mb-md-5 mb-lg-0">
                        ...
                        <p class="wow fadeIn animated">
                            <strong>Email: </strong>info@kzaman.me
                        </p>
                    ...
                    <div class="row">
                        <div class="col-md-8 col-lg-12">
                            ...
                            <div class="download-app wow fadeIn animated mob-app">
                                <a href="#" class="hover-up mb-sm-4 mb-lg-0">
                                    <img class="active" src="{{ asset('assets/imgs/theme/app-store.jpg') }}" />
                                </a>
                                <a href="#" class="hover-up">
                                    <img src="{{ asset('assets/imgs/theme/google-play.jpg') }}" />
                                </a>
                            </div>
                        </div>
                        <div class="col-md-4 col-lg-12 mt-md-3 mt-lg-0">
                            ...
                            <img class="wow fadeIn animated"
                                src="{{ asset('assets/imgs/theme/payment-method.png') }}" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <p class="float-md-left font-sm text-muted mb-0">
                    <a href="{{ route('privacy-policy') }}">
                        Privacy Policy</a> |
                    <a href="{{ route('terms-conditions') }}">Terms &
                        Conditions</a>
                </p>
            </div>
            <div class="col-lg-6">
                <p class="text-lg-end text-start font-sm text-muted mb-0">
                    &copy; <strong class="text-brand">DraftScripts</strong> All rights reserved
                </p>
            </div>
        </div>
    </div>
